...
[![Crates.io](https://img.shields.io/crates/v/Rusta-gateway.svg)](https://crates.io/crates/Rusta-gateway)
[![Documentation](https://docs.rs/Rusta-gateway/badge.svg)](https://docs.rs/Rusta-gateway)
[![License](https://img.shields.io/crates/l/Rusta-gateway.svg)](https://github.com/Alkamal01/rusta/blob/main/License)

High-performance multi-protocol API gateway built with Rust and Actix-Web.

## Overview

`Rusta-gateway` is the main executable binary for the Rusta API Gateway. It provides a production-ready, feature-rich gateway with support for multiple protocols including HTTP, WebSocket, FTP, and DNS.
...
- `Rusta_HOST`: Server host (default: 0.0.0.0)
- `Rusta_PORT`: Server port (default: 5900)
- `CONFIG_PATH`: Path to config.json (default: ./config.json)

### Example with Environment Variables

```bash
RUST_LOG=debug Rusta_PORT=8000 Rusta-gateway
```
...
services:
  Rusta-gateway:
    image: ghcr.io/Alkamal01/rusta:0.2.10
...
# Or specify platform
docker pull --platform linux/arm64 ghcr.io/Alkamal01/rusta:latest
```
...
```bash
docker exec -it Rusta-gateway sh
```

## Dependencies

This crate depends on [`rusta`](https://crates.io/crates/rusta) which provides the core gateway functionality.

## Documentation

- [Main Documentation](../../Readme.md)
- [WebSocket Guide](../../docs/WEBSOCKET_GUIDE.md)
- [API Documentation](https://docs.rs/Rusta-gateway)
- [Examples](../../examples/)
...
- [Crates.io](https://crates.io/crates/Rusta-gateway)
- [Documentation](https://docs.rs/Rusta-gateway)
- [Docker Images](https://github.com/Alkamal01/rusta/pkgs/container/rusta)
