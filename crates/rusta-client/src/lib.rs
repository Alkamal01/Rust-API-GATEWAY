//! Rusta Gateway Client Library
//!
//! This library provides client functionality for interacting with the Rusta API Gateway,
...
/// Client for interacting with Rusta API Gateway
