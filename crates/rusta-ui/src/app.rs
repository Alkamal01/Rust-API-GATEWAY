...
pub fn App() -> impl IntoView {
    ...
    view! {
        // Inject stylesheet
        <Stylesheet id="leptos" href="/pkg/Rusta-ui.css"/>
        
        // Set document title
        <Title text="Rusta Gateway - Admin UI"/>
        
        // Meta tags for SEO and responsiveness
        <Meta name="description" content="Rusta Gateway Admin Interface - Real-time monitoring and configuration"/>
