...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::{HeaderTransformation, TransformAction};
/// 
/// // Add a custom header
...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::PathTransformation;
/// 
...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::{QueryTransformation, TransformAction};
/// 
...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::{RequestTransformation, HeaderTransformation, PathTransformation, TransformAction};
/// 
...
///             value: Some("Rusta-gateway".to_string()),
///             pattern: None,
///             replacement: None,
///         }
///     ],
...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::{ResponseTransformation, HeaderTransformation, StatusCodeMapping, TransformAction};
...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::StatusCodeMapping;
/// use actix_web::http::StatusCode;
/// 
...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::{RequestTransformer, RequestTransformation, HeaderTransformation, TransformAction};
...
impl RequestTransformer {
    ...
    /// 
    /// ```rust
    /// use rusta_rs::middleware::transform::{RequestTransformer, RequestTransformation};
    /// 
...
/// 
/// ```rust
/// use rusta_rs::middleware::transform::{ResponseTransformer, ResponseTransformation};
/// 
