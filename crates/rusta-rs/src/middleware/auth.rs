//! JWT authentication middleware for the Rusta-rs gateway.
//! 
...
/// 
/// ```rust
/// use rusta_rs::middleware::auth::Claims;
/// 
/// let claims = Claims {
///     sub: "user123".to_string(),
///     exp: (chrono::Utc::now() + chrono::Duration::hours(1)).timestamp() as usize,
///     iat: chrono::Utc::now().timestamp() as usize,
///     iss: Some("Rusta-gateway".to_string()),
...
/// 
/// ```rust
/// use rusta_rs::middleware::auth::JwtConfig;
/// 
/// // Basic configuration
...
/// let config = JwtConfig::new("my-secret-key".to_string())
///     .with_issuer("Rusta-gateway".to_string())
...
/// use rusta_rs::middleware::auth::{JwtAuth, JwtConfig};
/// 
