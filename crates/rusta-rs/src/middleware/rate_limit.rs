...
/// use rusta_rs::middleware::rate_limit::{RateLimitConfig, LimitStrategy, WindowType};
/// 
...
///     enable_redis: false,
///     redis_key_prefix: "Rusta_rl".to_string(),
/// };
/// ```
...
impl AdvancedRateLimit {
    ...
    /// 
    /// ```rust
    /// use rusta_rs::middleware::rate_limit::{AdvancedRateLimit, RateLimitConfig, LimitStrategy, WindowType};
    /// use std::time::Duration;
    /// 
    /// let config = RateLimitConfig {
    ...
    ///     window_type: WindowType::SlidingWindow,
    ///     enable_redis: false,
    ///     redis_key_prefix: "Rusta".to_string(),
    /// };
    /// 
