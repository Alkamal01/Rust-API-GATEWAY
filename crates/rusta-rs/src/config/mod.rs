//! Configuration management for the Rusta-rs gateway.
//! 
...
//! 
//! - `Rusta_CONFIG_PATH`: Path to configuration file (default: `./config.json`)
//! - `Rusta_HOST`: Server bind address (default: `0.0.0.0`)
//! - `Rusta_PORT`: Server port number (default: `5900`)
