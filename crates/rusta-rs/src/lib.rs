//! # Rusta-rs API Gateway
//! 
//! A high-performance, async HTTP API gateway built with Rust and Actix Web.
//! Rusta-rs provides intelligent request routing, rate limiting, security features,
...
//! 
//! - `Rusta_CONFIG_PATH`: Configuration file path (default: `./config.json`)
//! - `Rusta_HOST`: Server bind address (default: `0.0.0.0`)
