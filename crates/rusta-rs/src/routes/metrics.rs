...
//! Rusta-rs gateway, including request counts, response times, error rates,
...
/// use rusta_rs::routes::metrics::MetricsCollector;
/// 
/// # fn example() {
/// let metrics = MetricsCollector::default();
/// let app = App::new()
///     .app_data(web::Data::new(metrics.clone()))
///     .configure(rusta_rs::routes::metrics::configure_metrics);
/// # }
/// ```
/// 
...
/// # Metrics Exposed
/// 
/// - **Rusta_requests_total**: Total HTTP requests processed (counter)
/// - **Rusta_requests_success_total**: Successful requests (counter)
/// - **Rusta_requests_error_total**: Failed requests (counter)
/// - **Rusta_response_time_avg**: Average response time in milliseconds (gauge)
/// - **Rusta_success_rate**: Success rate as percentage (gauge)
/// - **Rusta_active_connections**: Current active connections (gauge)
/// - **Rusta_uptime_seconds**: Service uptime in seconds (counter)
/// - **Rusta_circuit_breaker_state**: Circuit breaker state by service (gauge)
/// - **Rusta_circuit_breaker_failures**: Circuit breaker failure count (counter)
/// - **Rusta_circuit_breaker_successes**: Circuit breaker success count (counter)
/// 
/// # Response Format
/// 
/// Returns metrics in Prometheus exposition format:
/// ```text
/// # HELP Rusta_requests_total Total number of HTTP requests
/// # TYPE Rusta_requests_total counter
/// Rusta_requests_total 1547
/// 
/// # HELP Rusta_circuit_breaker_state Circuit breaker state (0=Closed, 1=Open, 2=HalfOpen)
/// # TYPE Rusta_circuit_breaker_state gauge
/// Rusta_circuit_breaker_state{service="api.example.com:443"} 0
/// ```
/// 
...
pub async fn metrics_endpoint(
    ...
    if let Some(handler) = route_handler {
        ...
        if !cb_states.is_empty() {
            ...
            circuit_breaker_metrics.push_str("# TYPE Rusta_circuit_breaker_state gauge\n");
            
            circuit_breaker_metrics.push_str("\n# HELP Rusta_circuit_breaker_failures Circuit breaker failure count\n");
            circuit_breaker_metrics.push_str("# TYPE Rusta_circuit_breaker_failures counter\n");
            
            circuit_breaker_metrics.push_str("\n# HELP Rusta_circuit_breaker_successes Circuit breaker success count\n");
            circuit_breaker_metrics.push_str("# TYPE Rusta_circuit_breaker_successes counter\n");
            ...
            for (service, (state, failures, successes)) in cb_states {
                ...
                circuit_breaker_metrics.push_str(&format!(
                    "Rusta_circuit_breaker_state{{service=\"{}\"}} {}\n",
                    service, state_value
                ));
                circuit_breaker_metrics.push_str(&format!(
                    "Rusta_circuit_breaker_failures{{service=\"{}\"}} {}\n",
                    service, failures
                ));
                circuit_breaker_metrics.push_str(&format!(
                    "Rusta_circuit_breaker_successes{{service=\"{}\"}} {}\n",
                    service, successes
                ));
            }
        }
    ...
    let metrics_text = format!(
        r#"# HELP Rusta_requests_total Total number of HTTP requests
# TYPE Rusta_requests_total counter
Rusta_requests_total {}

# HELP Rusta_requests_success_total Total number of successful HTTP requests
# TYPE Rusta_requests_success_total counter
Rusta_requests_success_total {}

# HELP Rusta_requests_error_total Total number of failed HTTP requests
# TYPE Rusta_requests_error_total counter
Rusta_requests_error_total {}

# HELP Rusta_http_4xx_errors_total Total number of 4xx client errors
# TYPE Rusta_http_4xx_errors_total counter
Rusta_http_4xx_errors_total {}

# HELP Rusta_http_5xx_errors_total Total number of 5xx server errors
# TYPE Rusta_http_5xx_errors_total counter
Rusta_http_5xx_errors_total {}

# HELP Rusta_timeout_errors_total Total number of timeout errors
# TYPE Rusta_timeout_errors_total counter
Rusta_timeout_errors_total {}

# HELP Rusta_connection_errors_total Total number of connection errors
# TYPE Rusta_connection_errors_total counter
Rusta_connection_errors_total {}

# HELP Rusta_response_time_avg Average response time in milliseconds
# TYPE Rusta_response_time_avg gauge
Rusta_response_time_avg {:.2}

# HELP Rusta_response_time_bucket Response time histogram buckets
# TYPE Rusta_response_time_bucket histogram
Rusta_response_time_bucket{{le="100"}} {}
Rusta_response_time_bucket{{le="500"}} {}
Rusta_response_time_bucket{{le="1000"}} {}
Rusta_response_time_bucket{{le="5000"}} {}
Rusta_response_time_bucket{{le="+Inf"}} {}

# HELP Rusta_request_bytes_total Total bytes received in requests
# TYPE Rusta_request_bytes_total counter
Rusta_request_bytes_total {}

# HELP Rusta_response_bytes_total Total bytes sent in responses
# TYPE Rusta_response_bytes_total counter
Rusta_response_bytes_total {}

# HELP Rusta_success_rate Success rate percentage
# TYPE Rusta_success_rate gauge
Rusta_success_rate {:.2}

# HELP Rusta_active_connections Current number of active connections
# TYPE Rusta_active_connections gauge
Rusta_active_connections {}

# HELP Rusta_peak_connections Peak number of concurrent connections
# TYPE Rusta_peak_connections gauge
Rusta_peak_connections {}

# HELP Rusta_uptime_seconds Service uptime in seconds
# TYPE Rusta_uptime_seconds counter
Rusta_uptime_seconds {}{}
"#,
        total_requests,
        success_requests,
        error_requests,
...
/// use rusta_rs::routes::metrics;
/// 
/// # fn example() {
/// # let metrics_collector = rusta_rs::routes::metrics::MetricsCollector::default();
/// let app = App::new()
