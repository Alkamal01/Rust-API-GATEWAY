//! DNS proxy route handling for the Rusta-rs gateway.
//!
...
/// use rusta_rs::routes::dns::configure_dns;
/// use rusta_rs::services::dns::DnsHandler;
/// use rusta_rs::models::router::Backend;
///
