...
/// 
/// ```rust
/// use rusta_rs::services::metrics_store::{MetricPoint, MetricValue};
/// use chrono::Utc;
/// 
...
/// 
/// ```rust
/// use rusta_rs::services::metrics_store::AggregationInterval;
/// 
...
/// 
/// ```rust
/// use rusta_rs::services::metrics_store::AggregatedMetric;
/// use chrono::Utc;
/// 
...
/// 
/// ```rust
/// use rusta_rs::services::metrics_store::{MetricsStore, MetricPoint, MetricValue};
...
impl MetricsStore {
    ...
    /// 
    /// ```rust
    /// use rusta_rs::services::metrics_store::{MetricsStore, MetricValue};
    /// use chrono::Duration;
    /// 
    ...
    /// 
    /// ```rust
    /// use rusta_rs::services::metrics_store::{MetricsStore, MetricValue, AggregationInterval};
    /// use chrono::{Utc, Duration};
    /// 
    /// let store = MetricsStore::new(1000, Duration::hours(1));
