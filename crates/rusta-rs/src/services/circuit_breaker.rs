...
///
/// ```
/// use rusta_rs::services::circuit_breaker::CircuitState;
///
...
/// use rusta_rs::services::circuit_breaker::CircuitBreakerConfig;
/// 
/// // Use defaults
...
impl CircuitBreaker {
    ...
    ///
    /// ```
    /// # use rusta_rs::services::circuit_breaker::{CircuitBreaker, CircuitBreakerConfig, CircuitState};
    /// # let breaker = CircuitBreaker::new("test".to_string(), CircuitBreakerConfig::default());
...
///
/// ```
/// use rusta_rs::services::circuit_breaker::{CircuitBreaker, CircuitBreakerConfig, CircuitBreakerError};
///
/// # async fn example() {
/// # let breaker = CircuitBreaker::new("test".to_string(), CircuitBreakerConfig::default());
