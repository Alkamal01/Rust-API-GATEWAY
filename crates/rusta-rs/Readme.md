...
[![Crates.io](https://img.shields.io/crates/v/rusta?color=blue)](https://crates.io/crates/rusta)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Security audit](https://img.shields.io/badge/security-audit-success.svg)](https://github.com/Alkamal01/rusta/security)


## What it actually does (right now)

Rusta is a production-ready multi-protocol gateway with modern web UI that:
...
Rusta now supports multiple protocols beyond HTTP:
...
docker pull ghcr.io/Alkamal01/rusta:0.2.10
```
...
services:
  Rusta-gateway:
    image: ghcr.io/Alkamal01/rusta:latest
...
rusta/
├── crates/
│   ├── rusta/        # Core library (models, routing logic)
│   ├── Rusta-gateway/   # Gateway binary (HTTP server)
│   ├── Rusta-ui/        # Web admin interface (Leptos SSR)
│   ├── Rusta-cli/       # Command-line interface
│   └── Rusta-client/    # Rust client library
```
...
Rusta supports 5 load balancing strategies:
...
Rusta provides REST endpoints for dynamic route management:
...
cargo test --package rusta

# Run UI tests only
cd crates/Rusta-ui && cargo test
...
**🚀 Exciting AI Vision:**
Rusta is pioneering the integration of AI/LLM capabilities into API gateway functionality:
...
This makes Rusta potentially the **first AI-powered open source API gateway** - combining traditional gateway reliability with cutting-edge AI capabilities.
...
**Maintainer**: [@Alkamal01](https://github.com/Alkamal01)  
